...
**Latest version: [1.19.0](https://github.com/studiopaulomoraes/Probox-CodeReviewer-releases/releases/tag/1.19.0)** · [All releases](https://github.com/studiopaulomoraes/Probox-CodeReviewer-releases/releases)

| Platform | Architecture | Format | Download |
|----------|--------------|--------|----------|
| **Windows** | x64 | ZIP | [**Download**](https://github.com/studiopaulomoraes/Probox-CodeReviewer-releases/releases/download/1.19.0/CodeReviewer-1.19.0-win.zip) |
| **macOS** | Apple Silicon (M1/M2/M3/M4) | ZIP | [**Download**](https://github.com/studiopaulomoraes/Probox-CodeReviewer-releases/releases/download/1.19.0/CodeReviewer-1.19.0-mac.zip) |
| **macOS** | Intel (x64) | ZIP | [**Download**](https://github.com/studiopaulomoraes/Probox-CodeReviewer-releases/releases/download/1.19.0/CodeReviewer-1.19.0-mac.zip) |
| **Linux** | amd64 | DEB | [**Download**](https://github.com/studiopaulomoraes/Probox-CodeReviewer-releases/releases/download/1.19.0/code-reviewer_1.19.0_amd64.deb) |
