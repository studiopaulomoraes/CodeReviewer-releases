...
**Latest version: [1.15.0](https://github.com/studiopaulomoraes/Probox-CodeReviewer-releases/releases/tag/1.15.0)** · [All releases](https://github.com/studiopaulomoraes/Probox-CodeReviewer-releases/releases)
...
| **macOS** | Apple Silicon (M1/M2/M3/M4) | ZIP | [**Download**](https://github.com/studiopaulomoraes/Probox-CodeReviewer-releases/releases/download/1.15.0/CodeReviewer-1.15.0-mac.zip) |
| **macOS** | Intel (x64) | ZIP | [**Download**](https://github.com/studiopaulomoraes/Probox-CodeReviewer-releases/releases/download/1.15.0/CodeReviewer-1.15.0-mac.zip) |
